...
from .views import ServiceList, ServiceDetail, ServiceDescriptionList, ServiceDescriptionDetail, OrderList, OrderDetail, PortfolioList, PortfolioDetail,TagList,TagDetail
